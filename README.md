...
- **Chain-of-Thoughts Financial Reasoning** — Prompts designed for numerical computation, ratio analysis, and year-over-year comparisons with explicit source citation.
